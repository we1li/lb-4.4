...
logging.basicConfig(
    ...
    format='%(asctime)s.%(msecs)03d - %(levelname)s - %(message)s',  # Формат логов с миллисекундами
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if command == "exit":  # Если команда "exit", выходим из программы
            ...
            logging.info(f"Выполнена команда: добавлен маршрут {number}.")  # Логируем выполнение команды
            ...
            logging.info(f"Выполнена команда: поиск маршрута {number}.")  # Логируем выполнение команды
        else:
            print("Неизвестная команда. Попробуйте снова.")  # Сообщение о неверной команде
